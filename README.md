...
Guidelines: https://kubegraf.github.io/lanther.ai/brand/

Logo files live in `public/brand/logo/` and are generated by `scripts/brand/build.py`
(needs `shapely`) and `scripts/brand/render.sh` (needs `rsvg-convert`). See CLAUDE.md.
